...
class MethodBinder1Test(IronPythonTestCase):
    ...
    def test_nullable_int(self):
        self._helper(self.target.M680, [None, 100, 100L, System.Byte.MaxValue, System.UInt32.MinValue, myint1, mylong2, 3.6, ], 680, [(), 3+1j], TypeError)
    ...
    def test_collections(self):
        ...
        # Int32, params Int32[]
        self._helper(self.target.M620, [(10, 10), (10L, 10), (10L, 10L), (10, 10L), (10, arrayInt), (10, (10, 20)), ], 620, [(10, [10, 20]), ], TypeError)
        self._helper(self.target.M620, [], 620, [(10, 123456789101234L), ], OverflowError)
...
'''
    ...
    def test_other_concern(self):
        ...
        # keywords
        x = self.target.M800(arg1 = 100, arg2 = 200L, arg3 = 'this'); self.assertEqual(x, 'THIS')
        x = self.target.M800(arg3 = 'Python', arg1 = 100, arg2 = 200L); self.assertEqual(x, 'PYTHON')
    ...
    def test_nullable_property_long(self):
        ...
        nt = NullableTest()
        nt.LProperty = 1
        self.assertEqual(nt.LProperty, 1L)
        nt.LProperty = 2L
        self.assertEqual(nt.LProperty, 2L)
        nt.LProperty = None
